...
//TODO (add boost):
//new graphic
//remove AT command for BRZ
//new warn level
//new calc
//new PID??
//try on regular arduino?s
...
static const unsigned char PROGMEM boost [] = {
  0b00000000, 0b00000000, 0b00001111, 0b11111110, //                     ###########
  0b00000000, 0b00111111, 0b11111000, 0b11110010, //           ###########   ####  #
  0b00000001, 0b11111111, 0b11111000, 0b11110010, //        ##############   ####  #
  0b00000111, 0b11110000, 0b00000000, 0b11110010, //      #######            ####  #
  0b00001111, 0b00000000, 0b00000000, 0b11110010, //     ####                ####  #
  0b00111110, 0b00000000, 0b00000000, 0b11110010, //   #####                 ####  #
  0b01111100, 0b00011111, 0b10000000, 0b11110010, //  #####     ######       ####  #
  0b01111000, 0b00111111, 0b11111000, 0b11110010, //  ####     ###########   ####  #
  0b11110000, 0b01111000, 0b11111111, 0b11111110, // ####     ####   ###############
  0b11100001, 0b11001100, 0b11111111, 0b11111110, // ###    ###  ##  ###############
  0b11000001, 0b10000101, 0b10011011, 0b00000000, // ##     ##    # ##  ## ##       
  0b11000001, 0b10000111, 0b00011001, 0b10000000, // ##     ##    ###   ##  ##      
  0b11100001, 0b10000110, 0b00011001, 0b10000000, // ###    ##    ##    ##  ##      
  0b01100001, 0b10111110, 0b00011001, 0b10000000, //  ##    ## #####    ##  ##      
  0b01111000, 0b11000010, 0b00110001, 0b10000000, //  ####   ##    #   ##   ##      
  0b01111000, 0b11110011, 0b11110001, 0b10000000, //  ####   ####  ######   ##      
  0b00111000, 0b00111111, 0b11000011, 0b10000000, //   ###     ########    ###      
  0b00011100, 0b00000000, 0b00000111, 0b10000000, //    ###               ####      
  0b00001110, 0b00000000, 0b00001111, 0b00000000, //     ###             ####       
  0b00001111, 0b11111111, 0b11111111, 0b00000000, //     ####################       
  0b00000011, 0b11111111, 0b11111000, 0b00000000, //       ###############          
  0b00000000, 0b00000000, 0b00000000, 0b00000000, //                                
  0b00011111, 0b11000001, 0b11110000, 0b11100000, //    #######     #####    ###    
  0b00011111, 0b11100111, 0b11111000, 0b11100000, //    ########  ########   ###    
  0b00011100, 0b11100111, 0b00111000, 0b11100000, //    ###  ###  ###  ###   ###    
  0b00011100, 0b11100111, 0b00000000, 0b11100000, //    ###  ###  ###        ###    
  0b00011100, 0b11100111, 0b11100000, 0b11100000, //    ###  ###  ######     ###    
  0b00011111, 0b11100011, 0b11110000, 0b11100000, //    ########   ######    ###    
  0b00011111, 0b11000000, 0b11111000, 0b11100000, //    #######      #####   ###    
  0b00011100, 0b00000111, 0b00111000, 0b11100000, //    ###       ###  ###   ###    
  0b00011100, 0b00000111, 0b00111000, 0b11100000, //    ###       ###  ###   ###    
  0b00011100, 0b00000011, 0b11110000, 0b11100000, //    ###        ######    ###    
};
...
void setup() {
 ...
 display.clearDisplay();
  ...
  display.display();
  getOBDIIvalue("obdboost"); //do the first reading here because it takes a sec or two  display.fillRect(8, 21, 2, 2, BLACK);
  ...
  display.clearDisplay();
  display.drawBitmap(0, 0, boost, 32, 32, 1);
  display.display();
}
...
void getVal(){
  if (mode == 0){
    curValue[mode] = getOBDIIvalue("obdboost");//modeList[mode]);
  }
  else if (mode == 1){
...
void updateVal(){
  ...
  if ( (mode ==0) || (mode == 1) || (mode == 2) ){ //AFR should show the decimal (others could be added to this list)
...
float getOBDIIvalue(String whichSensor){
  ...
  if (whichSensor.indexOf("obdboost") >= 0) {
    Status = Elm.runCommand("010B",data,20); //intake absolute manifold pressure
    value = ((float)(strtol(&data[6],0,16))*.145 - 14.69);
  }
